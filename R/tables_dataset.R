#' Compose table 1
#'
#' Create a table with the description of the link to the monograph
#'
...
#' Compose table 2
#'
#' Create a table with the distribution of the pre-processed
#' Tox.Monograph variable
#'
#' @param jecfa a data frame with the JECFA data
#'
#' @return a gtsummary table
...
#' Compose table 3
#'
#' Create a table with the distribution of strange cases
#'
#' @param jecfa a data frame with the JECFA data
#'
#' @return a gtsummary table
